...
class BlogService {
    ...
    constructor() {
        ...
        this.blogTagRepository = AppDataSource.getRepository(Tag);
    }
    ...
    private update = async (id, newblog) => {
        ...
        this.blogRepository.update({id: id}, {name: newblog.name, content: newblog.content, image: newblog.image, statusBlog: newblog.statusBlog});
